...
function fillPostTable(postList, status) {
    ...
    $.each(sortedPosts, function (arrayPosition, post) {
        ...
        postTable.append($('<a class="btn btn-primary" href="deleteBlogPost' + post.postId + '">Edit <span class="glyphicon glyphicon"></span></a>'));
        postTable.append($('<a class="btn btn-primary" href="editBlogPost' + post.postId + '">Delete <span class="glyphicon glyphicon"></span></a>'));
    });
}
